...
@app.get("/about")
def about():
    return {"message": "Fully Functiuonal API to manage patient records"}
...
# The dots in Path(...) represents it's required (although all path parameter are required)
...
def update_patient(patient_id: str, patient_update: PatientUpdate):
    ...
    updated_patient_info = patient_update.model_dump(exclude_unset= True)     #exclude_unset = True will set only the values recived to  update
